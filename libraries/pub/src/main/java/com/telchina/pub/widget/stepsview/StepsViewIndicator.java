...
public class StepsViewIndicator extends View {
    ...
    public StepsViewIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mNumOfStep = a.getInt(R.styleable.StepsViewIndicator_sv_numOfSteps, 0);
        a.recycle();
    ...
    public StepsViewIndicator setLineHeight(float lineHeight){
    	this.mLineHeight = lineHeight;
    	return this;
    }
    
    public StepsViewIndicator setThumbRadius(float thumbRadius){
    	this.mThumbRadius = thumbRadius;
    	return this;
    }
    
    public StepsViewIndicator setCircleRadius(float circleRadius){
    	this.mCircleRadius = circleRadius;
    	return this;
    }
    
    public StepsViewIndicator setLRPadding(float padding){
