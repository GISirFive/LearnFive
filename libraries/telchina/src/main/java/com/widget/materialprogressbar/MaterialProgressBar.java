...
package com.widget.materialprogressbar;

import com.orhanobut.logger.Logger;
import com.telchina.R;

import com.widget.materialprogressbar.internal.DrawableCompat;
        ...
        if (tint.mHasTintList || tint.mHasTintMode) {
            ...
            if (tint.mHasTintList) {
                if (drawable instanceof TintableDrawable) {
                	...
                	Logger.w("drawable did not implement TintableDrawable, it won't be tinted below Lollipop");
