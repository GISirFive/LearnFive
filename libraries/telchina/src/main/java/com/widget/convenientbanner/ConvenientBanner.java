package com.widget.convenientbanner;
...
import com.widget.convenientbanner.adapter.CBViewHolderCreator;
import com.widget.convenientbanner.listener.CBPageChangeListener;
import com.widget.convenientbanner.listener.OnItemClickListener;
import com.widget.convenientbanner.view.CBLoopViewPager;
...
//			scroller.setScrollDuration(1500);
    ...
    /** 用来解决多控件滑动/滚动事件冲突的问题 */
    private boolean mParentTouchEnable = false;
    ...
    /** 获取父控件是否可以滑动，用来解决多控件滑动/滚动事件冲突的问题
     * <b>该方法只有在调用setParent(ViewGroup parent)设置父控件后才生效</b>
     */
    public boolean getParentTouchEnable(){
    	return !mParentTouchEnable;
    }
	...
	private void setParentTouchEnable(boolean disallowIntercept){
		mParentTouchEnable = disallowIntercept;
		if(parent != null)
