...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public static final int VIEWFLOW_VIEWCHANGE = 0x1024;
...
//		mScroller.startScroll(getScrollX(), 0, delta, 0, Math.abs(delta) * 2);
		mScroller.startScroll(getScrollX(), 0, delta, 0, SNAP_DURATION);
		sendMessage(whichScreen);
		invalidate();
	}
